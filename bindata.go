...
func templatesBuildSh() (*asset, error) {
	bytes, err := templatesBuildShBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "templates/build.sh", size: 698, mode: os.FileMode(493), modTime: time.Unix(1454710734, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _templatesEntrypointDockerfile = []byte("")

func templatesEntrypointDockerfileBytes() ([]byte, error) {
	return bindataRead(
		_templatesEntrypointDockerfile,
		"templates/entrypoint/Dockerfile",
	)
}

func templatesEntrypointDockerfile() (*asset, error) {
	bytes, err := templatesEntrypointDockerfileBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "templates/entrypoint/Dockerfile", size: 132, mode: os.FileMode(420), modTime: time.Unix(1454710734, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesVersionGo() (*asset, error) {
	bytes, err := templatesVersionGoBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "templates/version.go", size: 82, mode: os.FileMode(420), modTime: time.Unix(1454710984, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"templates/Godeps": templatesGodeps,
	"templates/build.sh": templatesBuildSh,
	"templates/entrypoint/Dockerfile": templatesEntrypointDockerfile,
	"templates/main.go": templatesMainGo,
	"templates/version.go": templatesVersionGo,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"templates": &bintree{nil, map[string]*bintree{
		...
		"Godeps": &bintree{templatesGodeps, map[string]*bintree{}},
		"build.sh": &bintree{templatesBuildSh, map[string]*bintree{}},
		"entrypoint": &bintree{nil, map[string]*bintree{
			"Dockerfile": &bintree{templatesEntrypointDockerfile, map[string]*bintree{}},
		}},
		"main.go": &bintree{templatesMainGo, map[string]*bintree{}},
		"version.go": &bintree{templatesVersionGo, map[string]*bintree{}},
	}},
}}
